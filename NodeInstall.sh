...
echo -e 'Node Setup for HUSH'
echo -e 'March 20, 2019'
echo -e '\033[1;33m===============================================================================\033[0m'
...
echo -e '\033[1;33m===============================================================================\033[0m'
if [ -f ~/.hush/hush.conf ]; then
    echo -e "\033[1;36mExisting conf file found, backing up to hush.old ...\033[0m"
    sudo mv ~/.hush/hush.conf ~/.hush/hush.old;
fi
...
if [ "x$PASSWORD" = "x" ]; then
    ...
    sleep 3
    mkdir ~/.hush
    touch ~/.hush/$CONFIG_FILE
    echo "rpcuser=$RPCUSER" >> ~/.hush/$CONFIG_FILE
    echo "rpcpassword=$PASSWORD" >> ~/.hush/$CONFIG_FILE
    echo "rpcallowip=127.0.0.1" >> ~/.hush/$CONFIG_FILE
    #echo "rpcport=$RPCPORT" >> ~/.hush/$CONFIG_FILE
    #echo "port=$PORT" >> ~/.hush/$CONFIG_FILE
###    echo "zelnode=1" >> ~/.hush/$CONFIG_FILE
###    echo zelnodeprivkey=$zelnodeprivkey >> ~/.hush/$CONFIG_FILE
###    echo "server=1" >> ~/.hush/$CONFIG_FILE
    echo "daemon=1" >> ~/.hush/$CONFIG_FILE
    echo "txindex=1" >> ~/.hush/$CONFIG_FILE
###    echo "listen=1" >> ~/.hush/$CONFIG_FILE
###    echo "logtimestamps=1" >> ~/.hush/$CONFIG_FILE
###    echo "externalip=$WANIP" >> ~/.hush/$CONFIG_FILE
###    echo "bind=$WANIP" >> ~/.hush/$CONFIG_FILE
    echo "addnode=explorer.myhush.org" >> ~/.hush/$CONFIG_FILE
    echo "addnode=dnsseed.myhush.org" >> ~/.hush/$CONFIG_FILE
...
sudo chmod 555 /usr/bin/hush*
sudo rm -rf $WALLET_TAR_FILE && sudo rm -rf ~/hush-gtest && sudo rm -rf ~/fetch-params.sh
echo -e
...
User=$USERNAME
Group=$USERNAME
WorkingDirectory=/home/$USERNAME/.hush/
ExecStart=$COIN_PATH/$COIN_DAEMON -datadir=/home/$USERNAME/.hush/ -conf=/home/$USERNAME/.hush/$CONFIG_FILE -daemon
...
sleep 15
sudo chown -R $USERNAME:$USERNAME /home/$USERNAME
echo -e "\033[1;32mRestarting Node Daemon...\033[0m"
$COIN_DAEMON -daemon &> /dev/null
...
printf "\033[1;34m"
figlet -t -k "WELCOME   TO   HUSHNODES" 
printf "\e[0m"
echo -e
...
echo -e '\033[1;33m===============================================================================\033[0m'
echo -e 'HUSH SYNC STATUS - REFRESHES EVERY 10 SECONDS'
echo -e '\033[1;33m===============================================================================\033[0m'
echo -e
$COIN_CLI getinfo
sudo chown -R $USERNAME:$USERNAME /home/$USERNAME
